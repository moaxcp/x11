...
@Value
@Builder
public class RegisterClients implements OneWayRequest {
  ...
  public static class RegisterClientsBuilder {
    ...
    public RegisterClients.RegisterClientsBuilder elementHeaderEnable(HType... maskEnums) {
      for(HType m : maskEnums) {
    ...
    public RegisterClients.RegisterClientsBuilder elementHeaderDisable(HType... maskEnums) {
      for(HType m : maskEnums) {
