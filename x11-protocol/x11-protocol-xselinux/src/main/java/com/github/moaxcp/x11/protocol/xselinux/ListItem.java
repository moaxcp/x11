...
public class ListItem implements XStruct {
  ...
  @NonNull
  private ImmutableByteList objectContext;

  @NonNull
  private ImmutableByteList dataContext;
  ...
  public static ListItem readListItem(X11Input in) throws IOException {
    ...
    ImmutableByteList objectContext = in.readChar((int) (Integer.toUnsignedLong(objectContextLen)));
    in.readPadAlign((int) (Integer.toUnsignedLong(objectContextLen)));
    ImmutableByteList dataContext = in.readChar((int) (Integer.toUnsignedLong(dataContextLen)));
