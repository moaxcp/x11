...
public class SetCrtcTransform implements OneWayRequest {
  ...
  @NonNull
  private ImmutableByteList filterName;

  @NonNull
  private ImmutableIntList filterParams;
  ...
  public static SetCrtcTransform readSetCrtcTransform(X11Input in) throws IOException {
    ...
    javaStart += 2;
    ImmutableByteList filterName = in.readChar(Short.toUnsignedInt(filterLen));
    ...
    ImmutableIntList filterParams = in.readInt32(Short.toUnsignedInt(length) - javaStart);
