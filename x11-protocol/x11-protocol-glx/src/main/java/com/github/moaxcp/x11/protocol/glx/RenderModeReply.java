...
@Value
@Builder
public class RenderModeReply implements XReply {
  ...
  public static RenderModeReply readRenderModeReply(byte pad1, short sequenceNumber, X11Input in)
      throws IOException {
    RenderModeReply.RenderModeReplyBuilder javaBuilder = RenderModeReply.builder();
    int length = in.readCard32();
    int retVal = in.readCard32();
    int n = in.readCard32();
    int newMode = in.readCard32();
    byte[] pad7 = in.readPad(12);
    ImmutableIntList data = in.readCard32((int) (Integer.toUnsignedLong(n)));
  ...
  public static class RenderModeReplyBuilder {
    public int getSize() {
      return 32 + 4 * data.size();
    }
  }
