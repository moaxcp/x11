...
public class GetSupportedModifiersReply implements XReply {
  ...
  @NonNull
  private ImmutableLongList windowModifiers;

  @NonNull
  private ImmutableLongList screenModifiers;
  ...
  public static GetSupportedModifiersReply readGetSupportedModifiersReply(byte pad1,
    ...
    ImmutableLongList windowModifiers = in.readCard64((int) (Integer.toUnsignedLong(numWindowModifiers)));
    ImmutableLongList screenModifiers = in.readCard64((int) (Integer.toUnsignedLong(numScreenModifiers)));
