...
@Value
@Builder
public class CompositeGlyphs16 implements OneWayRequest {
  ...
  @NonNull
  private ImmutableByteList glyphcmds;
  ...
  public static CompositeGlyphs16 readCompositeGlyphs16(X11Input in) throws IOException {
    ...
    javaStart += 2;
    ImmutableByteList glyphcmds = in.readByte(Short.toUnsignedInt(length) - javaStart);
    javaBuilder.op(op);
    javaBuilder.src(src);
    javaBuilder.dst(dst);
