...
@Value
@Builder
public class ChangeDevicePropertyThirtyTwoBits implements ChangeDeviceProperty {
  ...
  public static ChangeDevicePropertyThirtyTwoBits readChangeDevicePropertyThirtyTwoBits(
