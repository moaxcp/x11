...
@Value
@Builder
public class ChangeDevicePropertyEightBits implements ChangeDeviceProperty {
  ...
  public static ChangeDevicePropertyEightBits readChangeDevicePropertyEightBits(byte majorOpcode,
      byte OPCODE, short length, int property, int type, byte deviceId, byte format, byte mode,
