...
@Value
@Builder
public class QueryAdaptorsReply implements XReply {
  public static final String PLUGIN_NAME = "xv";

  private short sequenceNumber;

  @NonNull
  private ImmutableList<AdaptorInfo> info;
  ...
  public static QueryAdaptorsReply readQueryAdaptorsReply(byte pad1, short sequenceNumber,
    ...
    MutableList<AdaptorInfo> info = Lists.mutable.withInitialCapacity(Short.toUnsignedInt(numAdaptors));
