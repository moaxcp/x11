...
public class QueryResourceBytesReply implements XReply {
  ...
  @NonNull
  private ImmutableList<ResourceSizeValue> sizes;
  ...
  public static QueryResourceBytesReply readQueryResourceBytesReply(byte pad1, short sequenceNumber,
    ...
    MutableList<ResourceSizeValue> sizes = Lists.mutable.withInitialCapacity((int) (Integer.toUnsignedLong(numSizes)));
