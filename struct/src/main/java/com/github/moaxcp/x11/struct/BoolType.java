...
import static com.github.moaxcp.x11.struct.Size.BOOL;
...
public final class BoolType extends PrimitiveType<Boolean> {
  ...
  @Override
  public Boolean get(Pointer<?, ? extends Type<?>> pointer) {
    throw new UnsupportedOperationException("get(Pointer) not supported for BooleanType. Use getBoolean(Pointer) instead.");
  }

  @Override
  public Boolean get(Pointer<?, ? extends Type<?>> pointer, long index) {
    throw new UnsupportedOperationException("get(Pointer, long) not supported for BooleanType. Use getBoolean(Pointer, long) instead.");
  }
  ...
  public void set(Pointer<?, ? extends Type<?>> pointer, Boolean value) {
    throw new UnsupportedOperationException("set(Pointer, Boolean) not supported for BooleanType. Use set(Pointer, boolean) instead.");
  }

  @Override
  public void set(Pointer<?, ? extends Type<?>> pointer, long index, Boolean value) {
    throw new UnsupportedOperationException("set(Pointer, long, Boolean) not supported for BooleanType. Use set(Pointer, long, boolean) instead.");
  }
  ...
  public void add(Pointer<?, ? extends Type<?>> pointer, Boolean value) {
    throw new UnsupportedOperationException("add(Pointer, Boolean) not supported for BooleanType. Use add(Pointer, boolean) instead.");
  }

  public void add(Pointer<?, ? extends Type<?>> pointer, long index, Boolean value) {
    throw new UnsupportedOperationException("add(Pointer, long, Boolean) not supported for BooleanType. Use add(Pointer, long, boolean) instead.");
  }
