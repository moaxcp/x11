...
public class Int16TypeTest {
  ...
  void constructorEverything() {
    ...
    var struct = struct()
        .int16()
        .field().constant((short) 5).lengthExpression(expression).assignment(add).int16()
        .build();
  ...
  void allocate_array_length_and_array_with_constant() {
    var struct = struct()
        .field().constant((short) 5).int16()
        .field().constant((short) 6).lengthField(0).int16()
        .build();
  ...
  void setInt16Array_constant_value_and_length() {
    var struct = struct()
        .field().constant((short) 5).lengthExpression(constant(5)).int16()
        .build();
  ...
  void setInt16Array_constant_value() {
    var struct = struct()
        .int16()
        .field().constant((short) 5).lengthField(0).int16()
