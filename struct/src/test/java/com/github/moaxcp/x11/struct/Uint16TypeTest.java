...
public class Uint16TypeTest {
  ...
  void constructorEverything() {
    ...
    var struct = struct()
        .uint16()
        .number().constant(5).lengthExpression(expression).assignment(add).uint16()
        .build();
  ...
  void isFixedLengthArray() {
    var struct = struct()
        .number().lengthExpression(constant(5)).uint16()
  ...
  void setUint16Array_constant_value_and_length() {
    var struct = struct()
        .number().constant(5).lengthExpression(constant(5)).uint16()
        .build();
  ...
  void setUint16Array_constant_value() {
    var struct = struct()
        .uint16()
        .number().constant(5).lengthField(0).uint16()
