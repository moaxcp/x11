...
public class ByteArrayFloat32Test {
  ...
  void float32_expand_array() {
    ...
    for (int i = 0; i < 10; i++) {
      assertThat(bytes.float32(i * 4)).isEqualTo(-i);
    }
  }
  ...
  void addFloat32() {
    ...
    assertThat(bytes.getBytes()).isEqualTo(new byte[] {65, 16, 0, 0, 65, 0, 0, 0, 64, -32, 0, 0, 64, -64, 0, 0, 64, -96, 0, 0, 64, -128, 0, 0, 64, 64, 0, 0, 64, 0, 0, 0, 63, -128, 0, 0, 0, 0, 0, 0, 100});
