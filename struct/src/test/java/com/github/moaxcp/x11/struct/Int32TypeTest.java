...
public class Int32TypeTest {
  ...
  void constructorEverything() {
    ...
    var struct = struct()
        .int32()
        .number().constant(5).lengthExpression(expression).assignment(add).int32()
        .build();
  ...
  void allocate_array_length_and_array_with_constant() {
    var struct = struct()
        .number().constant(5).int32()
        .number().constant(6).lengthField(0).int32()
        .build();
  ...
  void setInt32Array_constant_value_and_length() {
    var struct = struct()
        .number().constant(5).lengthExpression(constant(5)).int32()
        .build();
  ...
  void setInt32Array_constant_value() {
    var struct = struct()
        .int32()
        .number().constant(5).lengthField(0).int32()
        .fromBytes(new byte[] {
            0, 0, 0, 2,
            0, 0, 0, 5,
            0, 0, 0, 5
