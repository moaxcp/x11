...
@Value
@Builder
public class PutVideo implements OneWayRequest, XvObject {
  ...
  public static PutVideo readPutVideo(X11Input in) throws IOException {
    PutVideo.PutVideoBuilder javaBuilder = PutVideo.builder();
  ...
  public static class PutVideoBuilder {
    public int getSize() {
      return 32;
    }
  }
