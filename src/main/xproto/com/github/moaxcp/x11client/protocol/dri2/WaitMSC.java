...
@Value
@Builder
public class WaitMSC implements TwoWayRequest<WaitMSCReply>, Dri2Object {
  ...
  public XReplyFunction<WaitMSCReply> getReplyFunction() {
    return (field, sequenceNumber, in) -> WaitMSCReply.readWaitMSCReply(field, sequenceNumber, in);
  }
  ...
  public static WaitMSC readWaitMSC(X11Input in) throws IOException {
    WaitMSC.WaitMSCBuilder javaBuilder = WaitMSC.builder();
  ...
  public static class WaitMSCBuilder {
    public int getSize() {
      return 32;
    }
  }
