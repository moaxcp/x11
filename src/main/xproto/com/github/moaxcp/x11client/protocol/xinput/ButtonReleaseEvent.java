...
@Value
@Builder
public class ButtonReleaseEvent implements XGenericEvent, XinputObject {
  ...
  public static class ButtonReleaseEventBuilder {
    ...
    public ButtonReleaseEvent.ButtonReleaseEventBuilder flagsEnable(
    ...
    public ButtonReleaseEvent.ButtonReleaseEventBuilder flagsDisable(
        PointerEventFlags... maskEnums) {
      for(PointerEventFlags m : maskEnums) {
