...
@Value
@Builder
public class BadDrawableError implements XError, GlxObject {
  ...
  public static BadDrawableError readBadDrawableError(byte firstErrorOffset, X11Input in) throws
      IOException {
    BadDrawableError.BadDrawableErrorBuilder javaBuilder = BadDrawableError.builder();
  ...
  public static class BadDrawableErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
