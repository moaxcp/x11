...
@Value
@Builder
public class BadCurrentDrawableError implements XError, GlxObject {
  ...
  public static BadCurrentDrawableError readBadCurrentDrawableError(byte firstErrorOffset,
      X11Input in) throws IOException {
    BadCurrentDrawableError.BadCurrentDrawableErrorBuilder javaBuilder = BadCurrentDrawableError.builder();
  ...
  public static class BadCurrentDrawableErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
