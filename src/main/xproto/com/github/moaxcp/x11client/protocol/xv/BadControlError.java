...
@Value
@Builder
public class BadControlError implements XError, XvObject {
  ...
  public static BadControlError readBadControlError(byte firstErrorOffset, X11Input in) throws
      IOException {
    BadControlError.BadControlErrorBuilder javaBuilder = BadControlError.builder();
  ...
  public static class BadControlErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
