...
@Value
@Builder
public class IDChoiceError implements XError, XprotoObject {
  ...
  public static IDChoiceError readIDChoiceError(byte firstErrorOffset, X11Input in) throws
      IOException {
    IDChoiceError.IDChoiceErrorBuilder javaBuilder = IDChoiceError.builder();
  ...
  public static class IDChoiceErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
