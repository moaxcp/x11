...
@Value
@Builder
public class DeviceAbsCalibState implements XStruct, XinputObject {
  ...
  public static DeviceAbsCalibState readDeviceAbsCalibState(X11Input in) throws IOException {
    DeviceAbsCalibState.DeviceAbsCalibStateBuilder javaBuilder = DeviceAbsCalibState.builder();
  ...
  public static class DeviceAbsCalibStateBuilder {
    public DeviceAbsCalibState.DeviceAbsCalibStateBuilder controlId(DeviceControl controlId) {
      this.controlId = (short) controlId.getValue();
      return this;
    }

    public DeviceAbsCalibState.DeviceAbsCalibStateBuilder controlId(short controlId) {
