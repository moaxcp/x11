...
@Value
@Builder
public class BadContextTagError implements XError, GlxObject {
  ...
  public static BadContextTagError readBadContextTagError(byte firstErrorOffset, X11Input in) throws
      IOException {
    BadContextTagError.BadContextTagErrorBuilder javaBuilder = BadContextTagError.builder();
  ...
  public static class BadContextTagErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
