...
@Value
@Builder
public class DeviceBusyError implements XError, XinputObject {
  ...
  public static DeviceBusyError readDeviceBusyError(byte firstErrorOffset, X11Input in) throws
      IOException {
    DeviceBusyError.DeviceBusyErrorBuilder javaBuilder = DeviceBusyError.builder();
  ...
  public static class DeviceBusyErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
