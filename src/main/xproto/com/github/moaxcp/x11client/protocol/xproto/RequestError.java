...
@Value
@Builder
public class RequestError implements XError, XprotoObject {
  ...
  public static RequestError readRequestError(byte firstErrorOffset, X11Input in) throws
      IOException {
    RequestError.RequestErrorBuilder javaBuilder = RequestError.builder();
