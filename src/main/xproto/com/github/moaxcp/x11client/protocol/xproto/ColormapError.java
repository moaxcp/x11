...
@Value
@Builder
public class ColormapError implements XError, XprotoObject {
  ...
  public static ColormapError readColormapError(byte firstErrorOffset, X11Input in) throws
      IOException {
    ColormapError.ColormapErrorBuilder javaBuilder = ColormapError.builder();
  ...
  public static class ColormapErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
