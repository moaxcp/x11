...
@Value
@Builder
public class BadModeError implements XError, RandrObject {
  ...
  public static BadModeError readBadModeError(byte firstErrorOffset, X11Input in) throws
      IOException {
    BadModeError.BadModeErrorBuilder javaBuilder = BadModeError.builder();
  ...
  public static class BadModeErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
