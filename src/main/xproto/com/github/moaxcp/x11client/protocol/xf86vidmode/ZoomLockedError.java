...
@Value
@Builder
public class ZoomLockedError implements XError, Xf86vidmodeObject {
  ...
  public static ZoomLockedError readZoomLockedError(byte firstErrorOffset, X11Input in) throws
      IOException {
    ZoomLockedError.ZoomLockedErrorBuilder javaBuilder = ZoomLockedError.builder();
  ...
  public static class ZoomLockedErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
