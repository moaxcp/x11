...
@Value
@Builder
public class RawButtonPressEvent implements XGenericEvent, XinputObject {
  ...
  public static RawButtonPressEvent readRawButtonPressEvent(byte firstEventOffset,
      boolean sentEvent, byte extension, short sequenceNumber, int length, short eventType,
      X11Input in) throws IOException {
    RawButtonPressEvent.RawButtonPressEventBuilder javaBuilder = RawButtonPressEvent.builder();
  ...
  public static class RawButtonPressEventBuilder {
    public boolean isFlagsEnabled(@NonNull PointerEventFlags... maskEnums) {
      for(PointerEventFlags m : maskEnums) {
        if(!m.isEnabled(flags)) {
          return false;
    ...
    public RawButtonPressEvent.RawButtonPressEventBuilder flagsEnable(
    ...
    public RawButtonPressEvent.RawButtonPressEventBuilder flagsDisable(
        PointerEventFlags... maskEnums) {
      for(PointerEventFlags m : maskEnums) {
