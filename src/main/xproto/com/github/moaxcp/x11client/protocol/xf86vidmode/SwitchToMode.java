...
@Value
@Builder
public class SwitchToMode implements OneWayRequest, Xf86vidmodeObject {
  ...
  public static SwitchToMode readSwitchToMode(X11Input in) throws IOException {
    SwitchToMode.SwitchToModeBuilder javaBuilder = SwitchToMode.builder();
  ...
  public static class SwitchToModeBuilder {
    public boolean isFlagsEnabled(@NonNull ModeFlag... maskEnums) {
      for(ModeFlag m : maskEnums) {
        if(!m.isEnabled(flags)) {
          return false;
    ...
    public SwitchToMode.SwitchToModeBuilder flagsEnable(ModeFlag... maskEnums) {
      for(ModeFlag m : maskEnums) {
    ...
    public SwitchToMode.SwitchToModeBuilder flagsDisable(ModeFlag... maskEnums) {
      for(ModeFlag m : maskEnums) {
