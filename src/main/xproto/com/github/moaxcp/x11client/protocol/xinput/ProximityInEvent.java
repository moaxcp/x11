...
@Value
@Builder
public class ProximityInEvent implements XEvent, XinputObject {
  ...
  public static ProximityInEvent readProximityInEvent(byte firstEventOffset, boolean sentEvent,
      X11Input in) throws IOException {
    ProximityInEvent.ProximityInEventBuilder javaBuilder = ProximityInEvent.builder();
  ...
  public static class ProximityInEventBuilder {
    public boolean isStateEnabled(@NonNull KeyButMask... maskEnums) {
      for(KeyButMask m : maskEnums) {
        if(!m.isEnabled(state)) {
          return false;
    ...
    public ProximityInEvent.ProximityInEventBuilder stateEnable(KeyButMask... maskEnums) {
      for(KeyButMask m : maskEnums) {
    ...
    public ProximityInEvent.ProximityInEventBuilder stateDisable(KeyButMask... maskEnums) {
      for(KeyButMask m : maskEnums) {
