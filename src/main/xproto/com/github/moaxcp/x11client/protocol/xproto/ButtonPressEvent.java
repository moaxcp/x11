...
@Value
@Builder
public class ButtonPressEvent implements XEvent, XprotoObject {
  ...
  public static class ButtonPressEventBuilder {
    ...
    public ButtonPressEvent.ButtonPressEventBuilder stateEnable(KeyButMask... maskEnums) {
      for(KeyButMask m : maskEnums) {
    ...
    public ButtonPressEvent.ButtonPressEventBuilder stateDisable(KeyButMask... maskEnums) {
      for(KeyButMask m : maskEnums) {
