...
@Value
@Builder
public class BadRenderRequestError implements XError, GlxObject {
  ...
  public static BadRenderRequestError readBadRenderRequestError(byte firstErrorOffset, X11Input in)
      throws IOException {
    BadRenderRequestError.BadRenderRequestErrorBuilder javaBuilder = BadRenderRequestError.builder();
  ...
  public static class BadRenderRequestErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
