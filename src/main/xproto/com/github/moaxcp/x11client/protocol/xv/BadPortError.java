...
@Value
@Builder
public class BadPortError implements XError, XvObject {
  ...
  public static BadPortError readBadPortError(byte firstErrorOffset, X11Input in) throws
      IOException {
    BadPortError.BadPortErrorBuilder javaBuilder = BadPortError.builder();
  ...
  public static class BadPortErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
