...
@Value
@Builder
public class ExtensionDisabledError implements XError, Xf86vidmodeObject {
  ...
  public static ExtensionDisabledError readExtensionDisabledError(byte firstErrorOffset,
      X11Input in) throws IOException {
    ExtensionDisabledError.ExtensionDisabledErrorBuilder javaBuilder = ExtensionDisabledError.builder();
  ...
  public static class ExtensionDisabledErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
