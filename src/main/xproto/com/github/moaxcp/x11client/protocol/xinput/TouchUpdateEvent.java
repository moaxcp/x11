...
@Value
@Builder
public class TouchUpdateEvent implements XGenericEvent, XinputObject {
  ...
  public static TouchUpdateEvent readTouchUpdateEvent(byte firstEventOffset, boolean sentEvent,
      byte extension, short sequenceNumber, int length, short eventType, X11Input in) throws
      IOException {
    TouchUpdateEvent.TouchUpdateEventBuilder javaBuilder = TouchUpdateEvent.builder();
  ...
  public static class TouchUpdateEventBuilder {
    public boolean isFlagsEnabled(@NonNull TouchEventFlags... maskEnums) {
      for(TouchEventFlags m : maskEnums) {
        if(!m.isEnabled(flags)) {
          return false;
    ...
    public TouchUpdateEvent.TouchUpdateEventBuilder flagsEnable(TouchEventFlags... maskEnums) {
      for(TouchEventFlags m : maskEnums) {
    ...
    public TouchUpdateEvent.TouchUpdateEventBuilder flagsDisable(TouchEventFlags... maskEnums) {
      for(TouchEventFlags m : maskEnums) {
