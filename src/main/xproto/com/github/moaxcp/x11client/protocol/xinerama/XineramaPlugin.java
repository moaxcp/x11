...
public class XineramaPlugin implements XProtocolPlugin {
  public static final String NAME = "XINERAMA";
  ...
  public boolean supportedRequest(XRequest request) {
    ...
    if(request instanceof GetScreenCount) {
      return true;
    }
    if(request instanceof GetScreenSize) {
      return true;
    }
    if(request instanceof IsActive) {
      return true;
    }
    if(request instanceof QueryScreens) {
      return true;
    }
    return false;
  }
