...
@Value
@Builder
public class PixmapError implements XError, XprotoObject {
  ...
  public static PixmapError readPixmapError(byte firstErrorOffset, X11Input in) throws IOException {
    PixmapError.PixmapErrorBuilder javaBuilder = PixmapError.builder();
  ...
  public static class PixmapErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
