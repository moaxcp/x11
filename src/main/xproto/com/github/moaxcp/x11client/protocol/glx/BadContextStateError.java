...
@Value
@Builder
public class BadContextStateError implements XError, GlxObject {
  ...
  public static BadContextStateError readBadContextStateError(byte firstErrorOffset, X11Input in)
      throws IOException {
    BadContextStateError.BadContextStateErrorBuilder javaBuilder = BadContextStateError.builder();
  ...
  public static class BadContextStateErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
