...
@Value
@Builder
public class DeviceMotionNotifyEvent implements XEvent, XinputObject {
  ...
  public static DeviceMotionNotifyEvent readDeviceMotionNotifyEvent(byte firstEventOffset,
      boolean sentEvent, X11Input in) throws IOException {
    DeviceMotionNotifyEvent.DeviceMotionNotifyEventBuilder javaBuilder = DeviceMotionNotifyEvent.builder();
  ...
  public static class DeviceMotionNotifyEventBuilder {
    public boolean isStateEnabled(@NonNull KeyButMask... maskEnums) {
      for(KeyButMask m : maskEnums) {
        if(!m.isEnabled(state)) {
          return false;
    ...
    public DeviceMotionNotifyEvent.DeviceMotionNotifyEventBuilder stateEnable(
    ...
    public DeviceMotionNotifyEvent.DeviceMotionNotifyEventBuilder stateDisable(
        KeyButMask... maskEnums) {
      for(KeyButMask m : maskEnums) {
