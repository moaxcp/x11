...
@Value
@Builder
public class BadPixmapError implements XError, GlxObject {
  ...
  public static BadPixmapError readBadPixmapError(byte firstErrorOffset, X11Input in) throws
      IOException {
    BadPixmapError.BadPixmapErrorBuilder javaBuilder = BadPixmapError.builder();
  ...
  public static class BadPixmapErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
