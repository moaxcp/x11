...
@Value
@Builder
public class DeviceButtonReleaseEvent implements XEvent, XinputObject {
  ...
  public static DeviceButtonReleaseEvent readDeviceButtonReleaseEvent(byte firstEventOffset,
      boolean sentEvent, X11Input in) throws IOException {
    DeviceButtonReleaseEvent.DeviceButtonReleaseEventBuilder javaBuilder = DeviceButtonReleaseEvent.builder();
  ...
  public static class DeviceButtonReleaseEventBuilder {
    public boolean isStateEnabled(@NonNull KeyButMask... maskEnums) {
      for(KeyButMask m : maskEnums) {
        if(!m.isEnabled(state)) {
          return false;
    ...
    public DeviceButtonReleaseEvent.DeviceButtonReleaseEventBuilder stateEnable(
    ...
    public DeviceButtonReleaseEvent.DeviceButtonReleaseEventBuilder stateDisable(
        KeyButMask... maskEnums) {
      for(KeyButMask m : maskEnums) {
