...
@Value
@Builder
public class RawMotionEvent implements XGenericEvent, XinputObject {
  ...
  public static RawMotionEvent readRawMotionEvent(byte firstEventOffset, boolean sentEvent,
      byte extension, short sequenceNumber, int length, short eventType, X11Input in) throws
      IOException {
    RawMotionEvent.RawMotionEventBuilder javaBuilder = RawMotionEvent.builder();
  ...
  public static class RawMotionEventBuilder {
    public boolean isFlagsEnabled(@NonNull PointerEventFlags... maskEnums) {
      for(PointerEventFlags m : maskEnums) {
        if(!m.isEnabled(flags)) {
          return false;
    ...
    public RawMotionEvent.RawMotionEventBuilder flagsEnable(PointerEventFlags... maskEnums) {
      for(PointerEventFlags m : maskEnums) {
    ...
    public RawMotionEvent.RawMotionEventBuilder flagsDisable(PointerEventFlags... maskEnums) {
      for(PointerEventFlags m : maskEnums) {
