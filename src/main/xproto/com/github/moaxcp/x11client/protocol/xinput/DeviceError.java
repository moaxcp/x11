...
@Value
@Builder
public class DeviceError implements XError, XinputObject {
  ...
  public static DeviceError readDeviceError(byte firstErrorOffset, X11Input in) throws IOException {
    DeviceError.DeviceErrorBuilder javaBuilder = DeviceError.builder();
  ...
  public static class DeviceErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
