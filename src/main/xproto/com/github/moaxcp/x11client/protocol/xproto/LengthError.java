...
@Value
@Builder
public class LengthError implements XError, XprotoObject {
  ...
  public static LengthError readLengthError(byte firstErrorOffset, X11Input in) throws IOException {
    LengthError.LengthErrorBuilder javaBuilder = LengthError.builder();
  ...
  public static class LengthErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
