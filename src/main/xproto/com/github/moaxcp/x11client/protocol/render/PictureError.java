...
@Value
@Builder
public class PictureError implements XError, RenderObject {
  ...
  public static PictureError readPictureError(byte firstErrorOffset, X11Input in) throws
      IOException {
    PictureError.PictureErrorBuilder javaBuilder = PictureError.builder();
  ...
  public static class PictureErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
