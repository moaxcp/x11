...
@Value
@Builder
public class DeleteModeLine implements OneWayRequest, Xf86vidmodeObject {
  ...
  public static DeleteModeLine readDeleteModeLine(X11Input in) throws IOException {
    DeleteModeLine.DeleteModeLineBuilder javaBuilder = DeleteModeLine.builder();
  ...
  public static class DeleteModeLineBuilder {
    public boolean isFlagsEnabled(@NonNull ModeFlag... maskEnums) {
      for(ModeFlag m : maskEnums) {
        if(!m.isEnabled(flags)) {
          return false;
    ...
    public DeleteModeLine.DeleteModeLineBuilder flagsEnable(ModeFlag... maskEnums) {
      for(ModeFlag m : maskEnums) {
    ...
    public DeleteModeLine.DeleteModeLineBuilder flagsDisable(ModeFlag... maskEnums) {
      for(ModeFlag m : maskEnums) {
