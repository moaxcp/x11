...
@Value
@Builder
public class RawTouchBeginEvent implements XGenericEvent, XinputObject {
  ...
  public static RawTouchBeginEvent readRawTouchBeginEvent(byte firstEventOffset, boolean sentEvent,
      byte extension, short sequenceNumber, int length, short eventType, X11Input in) throws
      IOException {
    RawTouchBeginEvent.RawTouchBeginEventBuilder javaBuilder = RawTouchBeginEvent.builder();
  ...
  public static class RawTouchBeginEventBuilder {
    public boolean isFlagsEnabled(@NonNull TouchEventFlags... maskEnums) {
      for(TouchEventFlags m : maskEnums) {
        if(!m.isEnabled(flags)) {
          return false;
    ...
    public RawTouchBeginEvent.RawTouchBeginEventBuilder flagsEnable(TouchEventFlags... maskEnums) {
      for(TouchEventFlags m : maskEnums) {
    ...
    public RawTouchBeginEvent.RawTouchBeginEventBuilder flagsDisable(TouchEventFlags... maskEnums) {
      for(TouchEventFlags m : maskEnums) {
