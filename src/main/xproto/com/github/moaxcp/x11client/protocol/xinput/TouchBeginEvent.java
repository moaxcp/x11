...
@Value
@Builder
public class TouchBeginEvent implements XGenericEvent, XinputObject {
  ...
  public static TouchBeginEvent readTouchBeginEvent(byte firstEventOffset, boolean sentEvent,
      byte extension, short sequenceNumber, int length, short eventType, X11Input in) throws
      IOException {
    TouchBeginEvent.TouchBeginEventBuilder javaBuilder = TouchBeginEvent.builder();
  ...
  public static class TouchBeginEventBuilder {
    public boolean isFlagsEnabled(@NonNull TouchEventFlags... maskEnums) {
      for(TouchEventFlags m : maskEnums) {
        if(!m.isEnabled(flags)) {
          return false;
    ...
    public TouchBeginEvent.TouchBeginEventBuilder flagsEnable(TouchEventFlags... maskEnums) {
      for(TouchEventFlags m : maskEnums) {
    ...
    public TouchBeginEvent.TouchBeginEventBuilder flagsDisable(TouchEventFlags... maskEnums) {
      for(TouchEventFlags m : maskEnums) {
