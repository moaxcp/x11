...
@Value
@Builder
public class BadWindowError implements XError, GlxObject {
  ...
  public static BadWindowError readBadWindowError(byte firstErrorOffset, X11Input in) throws
      IOException {
    BadWindowError.BadWindowErrorBuilder javaBuilder = BadWindowError.builder();
  ...
  public static class BadWindowErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
