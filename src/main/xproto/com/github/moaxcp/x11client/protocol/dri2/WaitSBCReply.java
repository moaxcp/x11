...
@Value
@Builder
public class WaitSBCReply implements XReply, Dri2Object {
  ...
  public static WaitSBCReply readWaitSBCReply(byte pad1, short sequenceNumber, X11Input in) throws
      IOException {
    WaitSBCReply.WaitSBCReplyBuilder javaBuilder = WaitSBCReply.builder();
  ...
  public static class WaitSBCReplyBuilder {
    public int getSize() {
      return 32;
    }
  }
