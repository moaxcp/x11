...
@Value
@Builder
public class ImplementationError implements XError, XprotoObject {
  ...
  public static ImplementationError readImplementationError(byte firstErrorOffset, X11Input in)
      throws IOException {
    ImplementationError.ImplementationErrorBuilder javaBuilder = ImplementationError.builder();
  ...
  public static class ImplementationErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
