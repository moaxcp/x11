...
@Value
@Builder
public class ModeUnsuitableError implements XError, Xf86vidmodeObject {
  ...
  public static ModeUnsuitableError readModeUnsuitableError(byte firstErrorOffset, X11Input in)
      throws IOException {
    ModeUnsuitableError.ModeUnsuitableErrorBuilder javaBuilder = ModeUnsuitableError.builder();
  ...
  public static class ModeUnsuitableErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
