...
@Value
@Builder
public class BadCurrentWindowError implements XError, GlxObject {
  ...
  public static BadCurrentWindowError readBadCurrentWindowError(byte firstErrorOffset, X11Input in)
      throws IOException {
    BadCurrentWindowError.BadCurrentWindowErrorBuilder javaBuilder = BadCurrentWindowError.builder();
  ...
  public static class BadCurrentWindowErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
