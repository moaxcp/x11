...
@Value
@Builder
public class MotionEvent implements XGenericEvent, XinputObject {
  ...
  public static MotionEvent readMotionEvent(byte firstEventOffset, boolean sentEvent,
      byte extension, short sequenceNumber, int length, short eventType, X11Input in) throws
      IOException {
    MotionEvent.MotionEventBuilder javaBuilder = MotionEvent.builder();
  ...
  public static class MotionEventBuilder {
    public boolean isFlagsEnabled(@NonNull PointerEventFlags... maskEnums) {
      for(PointerEventFlags m : maskEnums) {
        if(!m.isEnabled(flags)) {
          return false;
    ...
    public MotionEvent.MotionEventBuilder flagsEnable(PointerEventFlags... maskEnums) {
      for(PointerEventFlags m : maskEnums) {
    ...
    public MotionEvent.MotionEventBuilder flagsDisable(PointerEventFlags... maskEnums) {
      for(PointerEventFlags m : maskEnums) {
