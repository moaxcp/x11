...
@Value
@Builder
public class GetVideo implements OneWayRequest, XvObject {
  ...
  public static GetVideo readGetVideo(X11Input in) throws IOException {
    GetVideo.GetVideoBuilder javaBuilder = GetVideo.builder();
  ...
  public static class GetVideoBuilder {
    public int getSize() {
      return 32;
    }
  }
