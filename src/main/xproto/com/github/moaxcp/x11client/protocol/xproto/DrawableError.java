...
@Value
@Builder
public class DrawableError implements XError, XprotoObject {
  ...
  public static DrawableError readDrawableError(byte firstErrorOffset, X11Input in) throws
      IOException {
    DrawableError.DrawableErrorBuilder javaBuilder = DrawableError.builder();
  ...
  public static class DrawableErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
