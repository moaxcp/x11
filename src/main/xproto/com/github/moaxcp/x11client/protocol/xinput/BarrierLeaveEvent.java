...
@Value
@Builder
public class BarrierLeaveEvent implements XGenericEvent, XinputObject {
  ...
  public static BarrierLeaveEvent readBarrierLeaveEvent(byte firstEventOffset, boolean sentEvent,
      byte extension, short sequenceNumber, int length, short eventType, X11Input in) throws
      IOException {
    BarrierLeaveEvent.BarrierLeaveEventBuilder javaBuilder = BarrierLeaveEvent.builder();
  ...
  public static class BarrierLeaveEventBuilder {
    public boolean isFlagsEnabled(@NonNull BarrierFlags... maskEnums) {
      for(BarrierFlags m : maskEnums) {
        if(!m.isEnabled(flags)) {
          return false;
    ...
    public BarrierLeaveEvent.BarrierLeaveEventBuilder flagsEnable(BarrierFlags... maskEnums) {
      for(BarrierFlags m : maskEnums) {
    ...
    public BarrierLeaveEvent.BarrierLeaveEventBuilder flagsDisable(BarrierFlags... maskEnums) {
      for(BarrierFlags m : maskEnums) {
