...
@Value
@Builder
public class BadClockError implements XError, Xf86vidmodeObject {
  ...
  public static BadClockError readBadClockError(byte firstErrorOffset, X11Input in) throws
      IOException {
    BadClockError.BadClockErrorBuilder javaBuilder = BadClockError.builder();
  ...
  public static class BadClockErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
