...
@Value
@Builder
public class AllocError implements XError, XprotoObject {
  ...
  public static AllocError readAllocError(byte firstErrorOffset, X11Input in) throws IOException {
    AllocError.AllocErrorBuilder javaBuilder = AllocError.builder();
  ...
  public static class AllocErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
