...
@Value
@Builder
public class RawTouchEndEvent implements XGenericEvent, XinputObject {
  ...
  public static RawTouchEndEvent readRawTouchEndEvent(byte firstEventOffset, boolean sentEvent,
      byte extension, short sequenceNumber, int length, short eventType, X11Input in) throws
      IOException {
    RawTouchEndEvent.RawTouchEndEventBuilder javaBuilder = RawTouchEndEvent.builder();
  ...
  public static class RawTouchEndEventBuilder {
    public boolean isFlagsEnabled(@NonNull TouchEventFlags... maskEnums) {
      for(TouchEventFlags m : maskEnums) {
        if(!m.isEnabled(flags)) {
          return false;
    ...
    public RawTouchEndEvent.RawTouchEndEventBuilder flagsEnable(TouchEventFlags... maskEnums) {
      for(TouchEventFlags m : maskEnums) {
    ...
    public RawTouchEndEvent.RawTouchEndEventBuilder flagsDisable(TouchEventFlags... maskEnums) {
      for(TouchEventFlags m : maskEnums) {
