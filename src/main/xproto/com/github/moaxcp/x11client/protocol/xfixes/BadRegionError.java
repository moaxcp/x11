...
@Value
@Builder
public class BadRegionError implements XError, XfixesObject {
  ...
  public static BadRegionError readBadRegionError(byte firstErrorOffset, X11Input in) throws
      IOException {
    BadRegionError.BadRegionErrorBuilder javaBuilder = BadRegionError.builder();
  ...
  public static class BadRegionErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
