...
@Value
@Builder
public class BadHTimingsError implements XError, Xf86vidmodeObject {
  ...
  public static BadHTimingsError readBadHTimingsError(byte firstErrorOffset, X11Input in) throws
      IOException {
    BadHTimingsError.BadHTimingsErrorBuilder javaBuilder = BadHTimingsError.builder();
  ...
  public static class BadHTimingsErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
