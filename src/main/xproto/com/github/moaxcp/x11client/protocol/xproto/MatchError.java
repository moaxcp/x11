...
@Value
@Builder
public class MatchError implements XError, XprotoObject {
  ...
  public static MatchError readMatchError(byte firstErrorOffset, X11Input in) throws IOException {
    MatchError.MatchErrorBuilder javaBuilder = MatchError.builder();
  ...
  public static class MatchErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
