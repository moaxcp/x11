...
@Value
@Builder
public class BadCrtcError implements XError, RandrObject {
  ...
  public static BadCrtcError readBadCrtcError(byte firstErrorOffset, X11Input in) throws
      IOException {
    BadCrtcError.BadCrtcErrorBuilder javaBuilder = BadCrtcError.builder();
  ...
  public static class BadCrtcErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
