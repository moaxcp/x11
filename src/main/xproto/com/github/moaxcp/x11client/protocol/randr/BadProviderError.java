...
@Value
@Builder
public class BadProviderError implements XError, RandrObject {
  ...
  public static BadProviderError readBadProviderError(byte firstErrorOffset, X11Input in) throws
      IOException {
    BadProviderError.BadProviderErrorBuilder javaBuilder = BadProviderError.builder();
  ...
  public static class BadProviderErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
