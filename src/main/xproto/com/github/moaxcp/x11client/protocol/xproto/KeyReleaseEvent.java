...
@Value
@Builder
public class KeyReleaseEvent implements XEvent, XprotoObject {
  ...
  public static class KeyReleaseEventBuilder {
    ...
    public KeyReleaseEvent.KeyReleaseEventBuilder stateEnable(KeyButMask... maskEnums) {
      for(KeyButMask m : maskEnums) {
    ...
    public KeyReleaseEvent.KeyReleaseEventBuilder stateDisable(KeyButMask... maskEnums) {
      for(KeyButMask m : maskEnums) {
