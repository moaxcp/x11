...
@Value
@Builder
public class TouchEndEvent implements XGenericEvent, XinputObject {
  ...
  public static TouchEndEvent readTouchEndEvent(byte firstEventOffset, boolean sentEvent,
      byte extension, short sequenceNumber, int length, short eventType, X11Input in) throws
      IOException {
    TouchEndEvent.TouchEndEventBuilder javaBuilder = TouchEndEvent.builder();
  ...
  public static class TouchEndEventBuilder {
    public boolean isFlagsEnabled(@NonNull TouchEventFlags... maskEnums) {
      for(TouchEventFlags m : maskEnums) {
        if(!m.isEnabled(flags)) {
          return false;
    ...
    public TouchEndEvent.TouchEndEventBuilder flagsEnable(TouchEventFlags... maskEnums) {
      for(TouchEventFlags m : maskEnums) {
    ...
    public TouchEndEvent.TouchEndEventBuilder flagsDisable(TouchEventFlags... maskEnums) {
      for(TouchEventFlags m : maskEnums) {
