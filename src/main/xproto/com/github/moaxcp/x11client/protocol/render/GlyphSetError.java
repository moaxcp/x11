...
@Value
@Builder
public class GlyphSetError implements XError, RenderObject {
  ...
  public static GlyphSetError readGlyphSetError(byte firstErrorOffset, X11Input in) throws
      IOException {
    GlyphSetError.GlyphSetErrorBuilder javaBuilder = GlyphSetError.builder();
  ...
  public static class GlyphSetErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
