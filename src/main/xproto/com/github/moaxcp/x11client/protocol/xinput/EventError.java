...
@Value
@Builder
public class EventError implements XError, XinputObject {
  ...
  public static EventError readEventError(byte firstErrorOffset, X11Input in) throws IOException {
    EventError.EventErrorBuilder javaBuilder = EventError.builder();
  ...
  public static class EventErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
