...
@Value
@Builder
public class LedFeedbackCtl implements XStruct, XinputObject {
  ...
  public static LedFeedbackCtl readLedFeedbackCtl(X11Input in) throws IOException {
    LedFeedbackCtl.LedFeedbackCtlBuilder javaBuilder = LedFeedbackCtl.builder();
  ...
  public static class LedFeedbackCtlBuilder {
    public LedFeedbackCtl.LedFeedbackCtlBuilder classId(FeedbackClass classId) {
      this.classId = (byte) classId.getValue();
      return this;
    }

    public LedFeedbackCtl.LedFeedbackCtlBuilder classId(byte classId) {
