...
@Value
@Builder
public class ValueError implements XError, XprotoObject {
  ...
  public static ValueError readValueError(byte firstErrorOffset, X11Input in) throws IOException {
    ValueError.ValueErrorBuilder javaBuilder = ValueError.builder();
  ...
  public static class ValueErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
