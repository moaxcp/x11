...
@Value
@Builder
public class UnsupportedPrivateRequestError implements XError, GlxObject {
  ...
  public static UnsupportedPrivateRequestError readUnsupportedPrivateRequestError(
      byte firstErrorOffset, X11Input in) throws IOException {
    UnsupportedPrivateRequestError.UnsupportedPrivateRequestErrorBuilder javaBuilder = UnsupportedPrivateRequestError.builder();
  ...
  public static class UnsupportedPrivateRequestErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
