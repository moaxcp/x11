...
@Value
@Builder
public class XIChangePropertyThirtyTwoBits implements XIChangeProperty, XinputObject {
  ...
  public static XIChangePropertyThirtyTwoBits readXIChangePropertyThirtyTwoBits(byte OPCODE,
