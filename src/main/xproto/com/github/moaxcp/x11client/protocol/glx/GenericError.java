...
@Value
@Builder
public class GenericError implements XError, GlxObject {
  ...
  public static GenericError readGenericError(byte firstErrorOffset, X11Input in) throws
      IOException {
    GenericError.GenericErrorBuilder javaBuilder = GenericError.builder();
