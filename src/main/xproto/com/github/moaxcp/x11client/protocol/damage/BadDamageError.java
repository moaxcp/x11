...
@Value
@Builder
public class BadDamageError implements XError, DamageObject {
  ...
  public static BadDamageError readBadDamageError(byte firstErrorOffset, X11Input in) throws
      IOException {
    BadDamageError.BadDamageErrorBuilder javaBuilder = BadDamageError.builder();
  ...
  public static class BadDamageErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
