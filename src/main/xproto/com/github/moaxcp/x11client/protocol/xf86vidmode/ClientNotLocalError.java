...
@Value
@Builder
public class ClientNotLocalError implements XError, Xf86vidmodeObject {
  ...
  public static ClientNotLocalError readClientNotLocalError(byte firstErrorOffset, X11Input in)
      throws IOException {
    ClientNotLocalError.ClientNotLocalErrorBuilder javaBuilder = ClientNotLocalError.builder();
  ...
  public static class ClientNotLocalErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
