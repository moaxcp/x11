...
@Value
@Builder
public class BadOutputError implements XError, RandrObject {
  ...
  public static BadOutputError readBadOutputError(byte firstErrorOffset, X11Input in) throws
      IOException {
    BadOutputError.BadOutputErrorBuilder javaBuilder = BadOutputError.builder();
  ...
  public static class BadOutputErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
