...
public class DpmsPlugin implements XProtocolPlugin {
  public static final String NAME = "DPMS";
  ...
  public boolean supportedRequest(XRequest request) {
    ...
    if(request instanceof Capable) {
      return true;
    }
    if(request instanceof GetTimeouts) {
      return true;
    }
    if(request instanceof SetTimeouts) {
      return true;
    }
    if(request instanceof Enable) {
      return true;
    }
    if(request instanceof Disable) {
      return true;
    }
    if(request instanceof ForceLevel) {
      return true;
    }
    if(request instanceof Info) {
      return true;
    }
    return false;
  }
