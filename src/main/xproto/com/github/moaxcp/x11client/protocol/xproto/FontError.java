...
@Value
@Builder
public class FontError implements XError, XprotoObject {
  ...
  public static FontError readFontError(byte firstErrorOffset, X11Input in) throws IOException {
    FontError.FontErrorBuilder javaBuilder = FontError.builder();
  ...
  public static class FontErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
