...
public class ShapePlugin implements XProtocolPlugin {
  ...
  public boolean supportedRequest(XRequest request) {
    ...
    if(request instanceof Rectangles) {
      return true;
    }
    if(request instanceof Mask) {
      return true;
    }
    if(request instanceof Combine) {
      return true;
    }
    if(request instanceof Offset) {
      return true;
    }
    if(request instanceof QueryExtents) {
      return true;
    }
    if(request instanceof SelectInput) {
      return true;
    }
    if(request instanceof InputSelected) {
      return true;
    }
    if(request instanceof GetRectangles) {
      return true;
    }
    return false;
  }
