...
@Value
@Builder
public class AtomError implements XError, XprotoObject {
  ...
  public static AtomError readAtomError(byte firstErrorOffset, X11Input in) throws IOException {
    AtomError.AtomErrorBuilder javaBuilder = AtomError.builder();
  ...
  public static class AtomErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
