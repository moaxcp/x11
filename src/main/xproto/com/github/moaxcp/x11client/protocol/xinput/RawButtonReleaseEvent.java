...
@Value
@Builder
public class RawButtonReleaseEvent implements XGenericEvent, XinputObject {
  ...
  public static RawButtonReleaseEvent readRawButtonReleaseEvent(byte firstEventOffset,
      boolean sentEvent, byte extension, short sequenceNumber, int length, short eventType,
      X11Input in) throws IOException {
    RawButtonReleaseEvent.RawButtonReleaseEventBuilder javaBuilder = RawButtonReleaseEvent.builder();
  ...
  public static class RawButtonReleaseEventBuilder {
    public boolean isFlagsEnabled(@NonNull PointerEventFlags... maskEnums) {
      for(PointerEventFlags m : maskEnums) {
        if(!m.isEnabled(flags)) {
          return false;
    ...
    public RawButtonReleaseEvent.RawButtonReleaseEventBuilder flagsEnable(
        PointerEventFlags... maskEnums) {
      for(PointerEventFlags m : maskEnums) {
    ...
    public RawButtonReleaseEvent.RawButtonReleaseEventBuilder flagsDisable(
        PointerEventFlags... maskEnums) {
      for(PointerEventFlags m : maskEnums) {
