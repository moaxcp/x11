...
@Value
@Builder
public class DeviceKeyPressEvent implements XEvent, XinputObject {
  ...
  public static DeviceKeyPressEvent readDeviceKeyPressEvent(byte firstEventOffset,
      boolean sentEvent, X11Input in) throws IOException {
    DeviceKeyPressEvent.DeviceKeyPressEventBuilder javaBuilder = DeviceKeyPressEvent.builder();
  ...
  public static class DeviceKeyPressEventBuilder {
    public boolean isStateEnabled(@NonNull KeyButMask... maskEnums) {
      for(KeyButMask m : maskEnums) {
        if(!m.isEnabled(state)) {
          return false;
    ...
    public DeviceKeyPressEvent.DeviceKeyPressEventBuilder stateEnable(KeyButMask... maskEnums) {
      for(KeyButMask m : maskEnums) {
    ...
    public DeviceKeyPressEvent.DeviceKeyPressEventBuilder stateDisable(KeyButMask... maskEnums) {
      for(KeyButMask m : maskEnums) {
