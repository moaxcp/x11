...
@Value
@Builder
public class ChangeDevicePropertySixteenBits implements ChangeDeviceProperty, XinputObject {
  ...
  public static ChangeDevicePropertySixteenBits readChangeDevicePropertySixteenBits(byte OPCODE,
