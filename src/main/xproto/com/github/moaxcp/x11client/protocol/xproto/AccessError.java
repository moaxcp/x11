...
@Value
@Builder
public class AccessError implements XError, XprotoObject {
  ...
  public static AccessError readAccessError(byte firstErrorOffset, X11Input in) throws IOException {
    AccessError.AccessErrorBuilder javaBuilder = AccessError.builder();
  ...
  public static class AccessErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
