...
@Value
@Builder
public class BadFBConfigError implements XError, GlxObject {
  ...
  public static BadFBConfigError readBadFBConfigError(byte firstErrorOffset, X11Input in) throws
      IOException {
    BadFBConfigError.BadFBConfigErrorBuilder javaBuilder = BadFBConfigError.builder();
  ...
  public static class BadFBConfigErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
