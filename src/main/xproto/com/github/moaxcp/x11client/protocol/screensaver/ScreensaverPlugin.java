...
public class ScreensaverPlugin implements XProtocolPlugin {
  public static final String NAME = "MIT-SCREEN-SAVER";
  ...
  public boolean supportedRequest(XRequest request) {
    ...
    if(request instanceof QueryInfo) {
      return true;
    }
    if(request instanceof SelectInput) {
      return true;
    }
    if(request instanceof SetAttributes) {
      return true;
    }
    if(request instanceof UnsetAttributes) {
      return true;
    }
    if(request instanceof Suspend) {
      return true;
    }
    return false;
  }
