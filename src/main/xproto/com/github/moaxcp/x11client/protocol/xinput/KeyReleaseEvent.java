...
@Value
@Builder
public class KeyReleaseEvent implements XGenericEvent, XinputObject {
  ...
  public static KeyReleaseEvent readKeyReleaseEvent(byte firstEventOffset, boolean sentEvent,
      byte extension, short sequenceNumber, int length, short eventType, X11Input in) throws
      IOException {
    KeyReleaseEvent.KeyReleaseEventBuilder javaBuilder = KeyReleaseEvent.builder();
  ...
  public static class KeyReleaseEventBuilder {
    public boolean isFlagsEnabled(@NonNull KeyEventFlags... maskEnums) {
      for(KeyEventFlags m : maskEnums) {
        if(!m.isEnabled(flags)) {
          return false;
    ...
    public KeyReleaseEvent.KeyReleaseEventBuilder flagsEnable(KeyEventFlags... maskEnums) {
      for(KeyEventFlags m : maskEnums) {
    ...
    public KeyReleaseEvent.KeyReleaseEventBuilder flagsDisable(KeyEventFlags... maskEnums) {
      for(KeyEventFlags m : maskEnums) {
