...
@Value
@Builder
public class KeyPressEvent implements XEvent, XprotoObject {
  ...
  public static class KeyPressEventBuilder {
    ...
    public KeyPressEvent.KeyPressEventBuilder stateEnable(KeyButMask... maskEnums) {
      for(KeyButMask m : maskEnums) {
    ...
    public KeyPressEvent.KeyPressEventBuilder stateDisable(KeyButMask... maskEnums) {
      for(KeyButMask m : maskEnums) {
