...
@Value
@Builder
public class BadPbufferError implements XError, GlxObject {
  ...
  public static BadPbufferError readBadPbufferError(byte firstErrorOffset, X11Input in) throws
      IOException {
    BadPbufferError.BadPbufferErrorBuilder javaBuilder = BadPbufferError.builder();
  ...
  public static class BadPbufferErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
