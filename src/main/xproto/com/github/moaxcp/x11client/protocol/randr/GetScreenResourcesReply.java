...
@Value
@Builder
public class GetScreenResourcesReply implements XReply, RandrObject {
  ...
  public static GetScreenResourcesReply readGetScreenResourcesReply(byte pad1, short sequenceNumber,
    ...
    GetScreenResourcesReply.GetScreenResourcesReplyBuilder javaBuilder = GetScreenResourcesReply.builder();
  ...
  public static class GetScreenResourcesReplyBuilder {
    public int getSize() {
      return 32 + 4 * crtcs.size() + 4 * outputs.size() + XObject.sizeOf(modes) + 1 * names.size();
    }
  }
