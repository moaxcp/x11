...
@Value
@Builder
public class GLXBadProfileARBError implements XError, GlxObject {
  ...
  public static GLXBadProfileARBError readGLXBadProfileARBError(byte firstErrorOffset, X11Input in)
      throws IOException {
    GLXBadProfileARBError.GLXBadProfileARBErrorBuilder javaBuilder = GLXBadProfileARBError.builder();
  ...
  public static class GLXBadProfileARBErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
