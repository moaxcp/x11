...
@Value
@Builder
public class BadLargeRequestError implements XError, GlxObject {
  ...
  public static BadLargeRequestError readBadLargeRequestError(byte firstErrorOffset, X11Input in)
      throws IOException {
    BadLargeRequestError.BadLargeRequestErrorBuilder javaBuilder = BadLargeRequestError.builder();
  ...
  public static class BadLargeRequestErrorBuilder {
    public int getSize() {
      return 32;
    }
  }
